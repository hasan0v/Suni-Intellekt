          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 bg-samsung-blue text-white py-2.5 px-5 rounded-xl samsung-body hover:bg-samsung-blue-dark focus:outline-none focus:ring-2 focus:ring-samsung-blue/20 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-samsung-card transition-all duration-300"
              >
